...
#unpack the trees
trowid, trockstar, tsnapnum, tx, ty, tz, tvx, tvy, tvz, tmass, trad, tdepthfirstid = np.loadtxt('trees/Trees_sn68_m6e13_2200_2300.csv', delimiter = ',', skiprows = 1, unpack = True)


f = open("treefile_2200_2300.csv", "w")
...
for i in range(73500,81000): #cyclethrough every pair in the final data set
	print i
