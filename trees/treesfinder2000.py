...
#unpack the trees
trowid, trockstar, tsnapnum, tx, ty, tz, tvx, tvy, tvz, tmass, trad, tdepthfirstid = np.loadtxt('trees/Trees_sn68_m6e13_2000_2100.csv', delimiter = ',', skiprows = 1, unpack = True)


f = open("treefile_2000_2100.csv", "w")
...
for i in range(67500,74000): #cyclethrough every pair in the final data set
	print i
