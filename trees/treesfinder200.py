...
#unpack the trees
trowid, trockstar, tsnapnum, tx, ty, tz, tvx, tvy, tvz, tmass, trad, tdepthfirstid = np.loadtxt('trees/Trees_sn68_m6e13_200_300.csv', delimiter = ',', skiprows = 1, unpack = True)


f = open("treefile_200_300.csv", "w")
...
for i in range(5500,11000): #cyclethrough every pair in the final data set
	print i
