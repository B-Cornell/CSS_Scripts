...
#unpack the trees
trowid, trockstar, tsnapnum, tx, ty, tz, tvx, tvy, tvz, tmass, trad, tdepthfirstid = np.loadtxt('trees/Trees_sn68_m6e13_700_800.csv', delimiter = ',', skiprows = 1, unpack = True)


f = open("treefile_700_800.csv", "w")
...
for i in range(23000,28500): #cyclethrough every pair in the final data set
	print i
