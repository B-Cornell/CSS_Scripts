...
#unpack the trees
trowid, trockstar, tsnapnum, tx, ty, tz, tvx, tvy, tvz, tmass, trad, tdepthfirstid = np.loadtxt('trees/Trees_sn68_m6e13_2100_2200.csv', delimiter = ',', skiprows = 1, unpack = True)


f = open("treefile_2100_2200.csv", "w")
...
for i in range(71000,77500): #cyclethrough every pair in the final data set
	print i
