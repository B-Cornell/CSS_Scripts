...
#unpack the trees
trowid, trockstar, tsnapnum, tx, ty, tz, tvx, tvy, tvz, tmass, trad, tdepthfirstid = np.loadtxt('trees/Trees_sn68_m6e13_1400_1500.csv', delimiter = ',', skiprows = 1, unpack = True)


f = open("treefile_1400_1500.csv", "w")
...
for i in range(47000,53000): #cyclethrough every pair in the final data set
	print i
