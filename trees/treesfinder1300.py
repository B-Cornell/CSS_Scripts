...
#unpack the trees
trowid, trockstar, tsnapnum, tx, ty, tz, tvx, tvy, tvz, tmass, trad, tdepthfirstid = np.loadtxt('trees/Trees_sn68_m6e13_1300_1400.csv', delimiter = ',', skiprows = 1, unpack = True)


f = open("treefile_1300_1400.csv", "w")
...
for i in range(44000,49500): #cyclethrough every pair in the final data set
	print i
