...
#unpack the trees
trowid, trockstar, tsnapnum, tx, ty, tz, tvx, tvy, tvz, tmass, trad, tdepthfirstid = np.loadtxt('trees/Trees_sn68_m6e13_100_200.csv', delimiter = ',', skiprows = 1, unpack = True)


f = open("treefile_100_200.csv", "w")
...
for i in range(2500,8000): #cyclethrough every pair in the final data set
	print i
