...
#unpack the trees
trowid, trockstar, tsnapnum, tx, ty, tz, tvx, tvy, tvz, tmass, trad, tdepthfirstid = np.loadtxt('trees/Trees_sn68_m6e13_1200_1300.csv', delimiter = ',', skiprows = 1, unpack = True)


f = open("treefile_1200_1300.csv", "w")
...
for i in range(40500,46000): #cyclethrough every pair in the final data set
	print i
