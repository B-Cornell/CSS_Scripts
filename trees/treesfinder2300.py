...
#unpack the trees
trowid, trockstar, tsnapnum, tx, ty, tz, tvx, tvy, tvz, tmass, trad, tdepthfirstid = np.loadtxt('trees/Trees_sn68_m6e13_2300_2400.csv', delimiter = ',', skiprows = 1, unpack = True)


f = open("treefile_2300_2400.csv", "w")
...
for i in range(74000,82248): #cyclethrough every pair in the final data set
	print i
